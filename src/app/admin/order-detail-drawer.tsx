        ...
        <div className="space-y-4 p-4">
          ...
          <section className="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
            ...
            <button
              ...
              disabled={busy}
              className="w-full rounded-xl border border-gray-200 bg-white px-3 py-2 text-left text-sm hover:bg-gray-50 disabled:opacity-50"
            >
          ...
          <section className="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
            ...
            <textarea
              ...
              placeholder="Visible solo en este panel, no para el cliente"
              rows={3}
              maxLength={2000}
            ...
            <button
              onClick={saveNotes}
              disabled={busy || (notesDraft === (order.internalNotes ?? ''))}
